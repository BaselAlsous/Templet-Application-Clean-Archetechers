...
import 'package:test/Core/Functions/color.dart';

/// App Colors Class - Resource class for storing app level color constants
class AppColors {
  static Color backgroundColor = HexColor.fromHex('F4F5F9');
  static Color backgroundColor2 = HexColor.fromHex('F5F5F5');
  static Color primaryColor = HexColor.fromHex('#EFAEC4');
  static Color darkPrimaryColor = HexColor.fromHex('#E289A7');
